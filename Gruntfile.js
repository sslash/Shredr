...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            compass: {
            files: ['<%= yeoman.app %>/styles/source/css/{,**/}*.{scss,sass}'],
                tasks: ['compass'] // sass app/styles/source/css/style.scss:app/styles/source/css/style.css
            },

            livereload: {
                files: [
                    '<%= yeoman.app %>/*.html',
                    '{.tmp,<%= yeoman.app %>}/styles/source/css/{,**/}*.css',
